import{r as e}from"./assets/rolldown-runtime-Cq0jCQ29.js";import{a as t,i as n,n as r,r as i,t as a}from"./assets/vendor-CLbvvtMQ.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var o=e(n(),1),s={categories:document.querySelector(`.categories-list`),furnitureList:document.querySelector(`.furniture-list`),loadMoreBtn:document.querySelector(`.load-more`),loader:document.querySelector(`.loader`),section:document.querySelector(`[data-feedback-section]`),loaderFeedback:document.querySelector(`[data-feedback-loader]`),readyState:document.querySelector(`[data-feedback-ready]`),list:document.querySelector(`[data-feedback-list]`),prevBtn:document.querySelector(`[data-feedback-prev]`),nextBtn:document.querySelector(`[data-feedback-next]`),pagination:document.querySelector(`[data-feedback-pagination]`),backdrop:document.querySelector(`.backdrop`),modalCloseBtn:document.querySelector(`.modal-close-btn`),modalContainer:document.querySelector(`.product-modal`),orderBtn:document.querySelector(`.order-btn`),productModal:document.querySelector(`#product-backdrop`),orderModal:document.querySelector(`#order-backdrop`),orderForm:document.querySelector(`#order-form`)},c=`https://furniture-store-v2.b.goit.study/api/feedbacks?page=1&limit=10`;async function l(){v();try{let e=await u();if(!e.length)throw Error(`No feedbacks available`);s.list.innerHTML=p(e),s.readyState.classList.remove(`hidden`),m(),d(e.length)}catch{b()}finally{y()}}async function u(){let{data:e}=await t.get(c);return(Array.isArray(e?.feedbacks)?e.feedbacks:Array.isArray(e)?e:[]).slice(0,10)}function d(e){new i(`[data-feedback-swiper]`,{slidesPerView:1,spaceBetween:24,speed:500,grabCursor:!0,allowTouchMove:e>1,breakpoints:{768:{slidesPerView:2,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}},keyboard:{enabled:!0,onlyInViewport:!0},navigation:{prevEl:s.prevBtn,nextEl:s.nextBtn,disabledClass:`is-disabled`},pagination:{el:s.pagination,clickable:!0,bulletElement:`button`,renderBullet(e,t){return`<button class="${t}" type="button" aria-label="Перейти до відгуку ${e+1}"></button>`}},on:{afterInit(e){f(e)},slideChange(e){f(e)},resize(e){f(e)}}})}function f(e){s.prevBtn.disabled=e.isBeginning,s.nextBtn.disabled=e.isEnd}function p(e){return e.map((e,t)=>{let n=e?.name??e?.author??`Anonymous`,r=e?.descr??e?.description??e?.review??`Клієнт поділився позитивним враженням про співпрацю з нами.`,i=h(Number(e?.rate??e?.rating??0));return`
   ...
   `)].join(``);s.categories.innerHTML=t}var P={Cірий:`#c7c3bb`,Жовтий:`#c7aa80`,Чорний:`#201a19`};function F(e){let t=e.map(e=>{let t=(e.colors||e.color||[]).slice(0,3);return`
   ...
   `}).join(``);s.furnitureList.insertAdjacentHTML(`beforeend`,t)}function I(){let e=document.querySelectorAll(`.color-checkbox-input`);e.length>0&&(e[0].checked=!0)}function L(e){let{_id:t,images:n,name:r,category:{name:i},price:a,rate:o,color:c,description:l,sizes:u}=e,d=c.map((e,t)=>`
...
border: ${e.toLowerCase()===`#FFFFFF`?`1px solid #E1E1E1`:`none`};"></span>
    ...
    <div class="product-modal" data-id="${t}">
      ...
      </div>`;s.modalContainer.innerHTML=f,R()}function R(){document.querySelectorAll(`[data-raty]`).forEach(e=>{e.children.length>0||new r(e,{score:e.dataset.score||0,readOnly:!0,half:!0,starType:`i`}).init()})}function z(e){(e.target.classList.contains(`backdrop`)||e.target.classList.contains(`modal-close-btn-svg`))&&(H(),document.removeEventListener(`keydown`,B),s.modalContainer.innerHTML=``),e.target.classList.contains(`order-btn`)&&(s.backdrop.classList.remove(`is-open`),document.removeEventListener(`keydown`,B),s.modalContainer.innerHTML=``)}function B(e){e.key===`Escape`&&(H(),document.removeEventListener(`keydown`,B),s.modalContainer.innerHTML=``)}function V(){s.backdrop.classList.add(`is-open`),document.body.style.overflow=`hidden`}function H(){s.backdrop.classList.remove(`is-open`),document.body.style.overflow=``}function U(){s.loader.classList.remove(`hidden`)}function W(){s.loader.classList.add(`hidden`)}function G(){s.loadMoreBtn.classList.remove(`hidden`)}function K(){s.loadMoreBtn.classList.add(`hidden`)}function q(e,t=`success`){let n={message:e,position:`bottomRight`,timeout:5e3};switch(t){case`success`:o.default.success(n);break;case`error`:o.default.error(n);break;case`warning`:o.default.warning(n);break;case`info`:o.default.info(n);break;default:o.default.error({message:`Invalid type of toast: ${t}`,position:`topRight`,timeout:5e3});break}}var J,Y=`all`,X;function Z(){J>=X?(K(),q(`Вибачте, більше результатів немає`,`warning`)):G()}async function Q(){J=1;try{U(),N(await k());let{furnitures:e,totalItems:t}=await A(J);X=Math.ceil(t/8),F(e),Z(),q(`Меблі успішно завантажено!`)}catch{q(`Щось пішло не так. Спробуйте ще раз пізніше, будь ласка.`,`error`)}finally{W()}}async function te(e){let t=e.target.closest(`.category-btn`);if(t){J=1,Y=t.dataset.id;try{document.querySelectorAll(`.category-btn`).forEach(e=>{e.classList.remove(`active`)}),t.classList.add(`active`),s.furnitureList.innerHTML=``;let e;U(),e=Y===`all`?await A(J):await j(Y,J);let{furnitures:n,totalItems:r}=e;X=Math.ceil(r/8),F(n),Z(),q(`Меблі успішно завантажено!`)}catch{q(`Щось пішло не так. Спробуйте ще раз, будь ласка.`,`error`)}finally{W()}}}async function ne(){J+=1;try{let e;U(),e=Y===`all`?await A(J):await j(Y,J);let{furnitures:t}=e;F(t),Z(),q(`Меблі успішно завантажено!`)}catch{q(`Щось пішло не так. Спробуйте ще раз, будь ласка.`,`error`)}finally{W()}}async function re(e){let t=e.target.closest(`li`).dataset.id;try{U();let e=await M(t);V(),L(e),I(),document.addEventListener(`keydown`,B)}catch{q(`Щось пішло не так. Спробуйте ще раз, будь ласка.`,`error`)}finally{W()}}var ie=e(a(),1);function ae(){new ie.default(`.accordion-container`,{duration:300,showMultiple:!1})}document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`year`);e&&(e.textContent=new Date().getFullYear())});function oe(e){let t=e.target.closest(`.order-btn`);if(!t)return;let n=t.getAttribute(`data-id`);document.querySelector(`#product-id`).value=n;let r=document.querySelector(`input[name="color"]:checked`)?.value;document.querySelector(`#product-color`).value=r,se(),document.addEventListener(`keydown`,$)}function se(){s.orderModal.classList.add(`is-open`),document.body.style.overflow=`hidden`}function ce(e){(e.target.classList.contains(`backdrop`)||e.target.classList.contains(`modal-close-btn-svg`))&&(s.orderModal.classList.remove(`is-open`),document.body.style.overflow=``,document.removeEventListener(`keydown`,$))}function $(e){e.key===`Escape`&&(s.orderModal.classList.remove(`is-open`),document.body.style.overflow=``,document.removeEventListener(`keydown`,$))}async function le(e){e.preventDefault();let{name:n,phone:r,productId:i,color:a}=e.target.elements,o={name:n.value,phone:r.value,modelId:i.value,color:a.value};console.log(o);try{U();let n=(await t.post(`/orders`,o)).data;q(`Ваші дані успішно відправлені. Номер замовлення ${n.orderNum}`),s.orderModal.classList.remove(`is-open`),document.body.style.overflow=``,e.target.reset()}catch{q(`Щось пішло не так. Спробуйте ще раз пізніше, будь ласка.`,`error`)}finally{W()}}document.addEventListener(`DOMContentLoaded`,()=>{Q(),ae(),l()}),s.categories.addEventListener(`click`,te),s.loadMoreBtn.addEventListener(`click`,ne),s.furnitureList.addEventListener(`click`,re),s.modalContainer.addEventListener(`click`,oe),s.productModal.addEventListener(`click`,z),s.orderModal.addEventListener(`click`,ce),s.orderForm.addEventListener(`submit`,le);
